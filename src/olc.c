...
CH_CMD ( do_aedit )
{
    ...
    else
    {
        if ( !str_cmp ( arg, "create" ) )
        {
            ...
            {
                send_to_char ( "Area already exists.", ch );
                return;
            }
            pArea = new_area (  );
    ...
    if ( !IS_BUILDER ( ch, pArea ) )
    {
        send_to_char ( "Insufficient security to modify areas.\n\r", ch );
        return;
    }
...
CH_CMD ( do_redit )
{
    ...
    else
    {
        ...
        {
            send_to_char ( "Insufficient security to create room.\n\r", ch );
            return;
        }
    }
    ...
    if ( !IS_BUILDER ( ch, pRoom->area ) )
    {
        send_to_char ( "Insufficient security to edit room.\n\r", ch );
        return;
    }
...
CH_CMD ( do_medit )
{
    ...
    if ( is_number ( arg1 ) )
    {
        ...
        {
            send_to_char ( "Insufficient security to create mobile.\n\r", ch );
            return;
        }
